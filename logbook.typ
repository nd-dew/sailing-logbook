...
#v(0.5em)
- #sym.ballot *Water Ingress:* Taste test – salty (external leak) or fresh (plumbing). Close seacocks, cut unnecessary power, start bilge pumps, locate source.
...
#v(0.5em)
- #sym.ballot *Forgive minor faults:* It's a week together; speak directly and calmly.
- #sym.ballot *Watches & Sleeping:* Shared cabins, quiet hours; ALWAYS wake the Captain if in doubt.
- #sym.ballot *Water & Toilets:* Conserve water; follow yacht toilet rules (no paper in the bowl).
- #sym.ballot *Gas Stove:* Cut source (valve) first, then the burner. Fire extinguisher and blanket ready.
- #sym.ballot *Damage:* Shared responsibility; insurance deposit, but report everything immediately (photos, time, circumstances).

#v(2em)

#heading(level: 2)[Yacht Basics]
#v(0.5em)
- #sym.ballot *Knots:* Cleat hitch (mooring lines), Bowline (loop). Practice with eyes closed.
- #sym.ballot *Winches:* Line from bottom, 3–4 wraps, "on top", fingers away. Commands: "taking/easing" – confirm loudly.
- #sym.ballot *Port Maneuvers:* No jokes. Short, loud reports ("stern 2m, drifting left"). Wait for Captain's confirmation.
